 ...
 */
function mothership_ninesixty_preprocess_page(&$vars, $hook) {
  ...
  $vars['css_alt'] = mothership_ninesixty_css_reorder($vars['css']);
 ...
 * weighted styles.
 */
function mothership_ninesixty_css_reorder($css) {
